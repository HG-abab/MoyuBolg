        ...
        <el-header class="header">
          <div class="header-img" v-lazy="articles.articleCover">
            <div class="text">
              ...
              <div style="display: flex; justify-content: start; align-items: center;">
                <div class="statistics" style="margin-right: 1rem; width:auto; height: 36px;margin-top: 1rem; padding: 0 3px;">访问量:{{articles.visitCount}}</div>
                <div class="statistics" style="margin-right: 1rem; width:auto; height: 36px;margin-top: 1rem; padding: 0 3px;">评论数:{{articles.commentsCount}} </div>
                <div class="statistics" style="margin-right: 1rem; width:auto; height: 36px;margin-top: 1rem; padding: 0 3px;">点赞量:{{articles.likesCount}} </div>
                <div class="statistics" style="margin-right: 1rem; width:auto; height: 36px;margin-top: 1rem; padding: 0 3px;">收藏量:{{articles.favoritesCount}} </div>
              </div>
              <div style="display: flex; justify-content: start; align-items: center;">
                <div class="statistics" style="margin-right: 1rem; width:auto; height: 36px;margin-top: 1rem; padding: 0 3px;">发布:{{articles.createTime}}</div>
              </div>
            </div>
          </div>
        </el-header>
        ...
        <el-footer class="footer">
          ...
          <div style="display: flex;justify-content: space-between;margin:0.6rem 0;">
            <div class="tagsName" @click="$router.push('/tabs')">
              <div v-for="item in articles.tagsName" class="tag" style="margin: .5rem;padding: .5rem .9rem;border: 1px solid #ccc ;border-radius: 5px;">
                <div>#{{item.name}}</div>
              </div>
            </div>
            <div class="like">
              ...
              <div class="icon">
                <div @click="collectArticle" style="pading:0.6rem 0;margin: 0 0.6rem;display: flex;align-items: center;">
          ...
          <div class="categoryName">
            <div @click="$router.push('/category')" class="tag" style="margin: .5rem;padding: .5rem .9rem;border: 1px solid #ccc ;border-radius: 5px;">
          ...
          <comment :type="1" :is-show-header="true" :author-Name="articles.userName" :type-id="articles.id" v-if="articles.id" />
        </el-footer>
      </el-container>
