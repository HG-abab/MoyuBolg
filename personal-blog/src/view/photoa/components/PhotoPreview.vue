<script setup>
  ...
  const scaleMultiplier = ref(0.002);
  ...
  function handleTouchMove(e) {
    if (e.touches.length === 1 && isDragging.value) {
      ...
      scale.value = Math.min(Math.max(startScale.value * scaleFactor, minScale.value), maxScale.value);
    }
  }
  ...
  function handleWheel(e) {
    e.preventDefault();
    const delta = -e.deltaY * scaleMultiplier.value;
    ...
    <div class="preview-content" @click.stop>
      <div class="preview-image-container">
        <div class="drag-container" :style="{
          ...
          <img :key="currentIndex" :src="photos[currentIndex]" :style="{
            ...
            ]" @mousedown="handleMouseDown" @wheel.prevent="handleWheel" @touchstart.prevent="handleTouchStart" @touchmove.prevent="handleTouchMove" @touchend.prevent="handleTouchEnd" @touchcancel.prevent="handleTouchEnd" @dragstart.prevent draggable="false" alt="预览图片">
        </div>
      </div>
